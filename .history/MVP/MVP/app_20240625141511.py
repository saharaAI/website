...
def generer_document_aleatoire():
    ...
    # call gemini api
    prompt = f"Imagine a full writien demand of loan document with key financial indicators and realistic numbers, payements , fuller remplit, sois cratifetc in French based on info: {document}"
