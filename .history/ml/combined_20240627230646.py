...
class CreditRiskModel:
    ...
    def train_model(self, num_epochs=20, batch_size=64):
        if self.model_type == 'neural_network':
            ...
            joblib.dump(self.model, f'./Classifier_CreditScoring_{self.model_type}.pkl')
            print(f"Model trained and saved as Classifier_CreditScoring_{self.model_type}.pkl")
...
if __name__ == "__main__":
    ...
    for model_type in model_types:
        ...
        result = {'Model': model_type, 'Accuracy': accuracy, 'ROC AUC': roc, 'Report': report}
