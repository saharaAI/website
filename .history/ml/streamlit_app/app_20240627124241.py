...
if uploaded_file is not None:
    try:
        ...
        st.write(
            confusion_matrix(model.y_test, model.classifier.predict(model.X_test))
        )
...
# Benchmarking (Optional - if you still want this in the app)
if st.checkbox("Run Benchmark (This may take a while)"):
    # ... (Code for benchmarking remains similar, but display results in Streamlit) ...
