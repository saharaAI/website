...
class CreditRiskModel:
    ...
    def split_data(self, test_size=0.1, random_state=0):
...
if st.sidebar.checkbox("Run Benchmark ..."):
    ...
    st.markdown("**Note:** Benchmarking is currently in development. Please use the model trained in production for benchmarking.")
    benchmark_results = []
