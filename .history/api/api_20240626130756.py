...
class CreditRiskAnalyzer:
    ...
    def __init__(self, config: Config):
        ...
        self.prompts = {
            0: "Act like expert in this domain and a prospective borrower. Evaluate the creditworthiness of the individual applicant based on the following credit report. Highlight key factors affecting their credit score and risk profile: ",
