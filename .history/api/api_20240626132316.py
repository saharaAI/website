...
class CreditRiskAnalyzer:
    ...
    def process_uploaded_file(self, file: UploadFile):
        ...
        # TODO: Implement logic to extract content from different file types (txt, pdf, csv)
        # For simplicity, this example assumes you can directly read the content as text
        use this : from unstructured.partition.auto import partition
