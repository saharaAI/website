...
class CreditRiskAnalyzer:
    ...
    def process_uploaded_file(self, file: UploadFile):
        ...
        # Save the uploaded file locally ./uploads
        ...
        # Process the file locally using a command line tool or function
        # Replace 'unstructured' with the actual command or function you want to use
        command = f"unstructured {file_path} --output-dir {self.config.UPLOAD_FOLDER}"
        os.system(command)

        # Example: Partition function assuming it's defined elsewhere
